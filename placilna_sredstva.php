...
<head>
    ...
    <link rel="stylesheet" href="/css/kje-smo.css">
</head>
...
<body>
    ...
    <div class="container">
        <div class="row mt-4 mb-3">
            ...
            <div class="col-lg-6 text-center"><h1 class="display-4"> Načini plačila</h2></div>
            <div class="col-lg-3"></div>
        </div>
        <div class="row mb-5">
            <div class="col-lg-3"></div>
            <div class="col-lg-6 text-center"><p class="h4 text-muted"> Sprejemamo različne vrste plačilnih sredstev </p></div>
            <div class="col-lg-3"></div>
        </div>
    </div>
    <div class="container">
        <div class="row ml-5">
            <div class="col-lg-2 mt-5"><i class="fa fa-cc-visa fa-5x"></i></div>
            <div class="col-lg-2 mt-5 pl-n4"><i class="fa fa-cc-mastercard fa-5x"></i></div>
            <div class="col-lg-2 mt-5 pl-n4"><i class="fa fa-cc-discover fa-5x"></i></div>
            <div class="col-lg-2 mt-5 pl-n4"><i class="fa fa-cc-amex fa-5x"></i></div>
            <div class="col-lg-2 mt-5 pl-n4"><i class="fa fa-cc-paypal fa-5x"></i></div>
            <div class="col-lg-2 mt-5 pl-n4"><i class="fa fa-cc-stripe fa-5x"></i></div>
        </div>
    </div>
