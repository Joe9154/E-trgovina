...
<body>
    ...
    <div class="container">
        <div class="row mt-4 mb-3">
            ...
            <div class="col-lg-6 text-center"><h1 class="display-4"> Kje se nahajamo?</h2></div>
            <div class="col-lg-3"></div>
        </div>
        <div class="row mb-5">
            <div class="col-lg-3"></div>
            <div class="col-lg-6 text-center"><p class="h4 text-muted"> Ljubljanska cesta 1, 1000 Ljubljana </p></div>
            <div class="col-lg-3"></div>
        </div>
    </div>
    <div class="container">
        <div class="map-responsive">
            <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Ljubljanska+cesta+1" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
    </div>
